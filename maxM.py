# creating a function which can find the maximium number in the list
numbers = [560,450,456,767,1000,345,150,987,634,589,238,189,899,1500]

def maximum_num(num_list):
    mini_num = 0
